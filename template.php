 ...
 */
function greenandpeter_theme_preprocess_page(&$vars, $hook) {
...
function greenandpeter_theme_webform_grid($element) {
  $rows = array();
 ...
 */
function greenandpeter_theme_breadcrumb($breadcrumb) {
 ...
 */
function greenandpeter_theme_menu_local_tasks() {
  $output = '';
...
/**
 * greenandpeter_theme_preprocess_search_theme_form().
 */
function greenandpeter_theme_preprocess_search_theme_form(&$vars, $hook) {
 ...
 */
function greenandpeter_theme_form_element($element, $value) {
 ...
 */
function greenandpeter_theme_textfield($element) {
 ...
 * Override theme_textfield().
 */
function greenandpeter_theme_webform_email($element) {
  // Add bootstrap classes
  $class = array('form-control');
 ...
 */
function greenandpeter_theme_textarea($element) {
 ...
 */
function greenandpeter_theme_password($element) {
 ...
 */
function greenandpeter_theme_select($element) {
 ...
 */
function greenandpeter_theme_checkbox($element) {
